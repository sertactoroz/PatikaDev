const menu = [
  ...
  },
  {
    ...
    price: 5.99,
    img:
    "https://www.savingdessert.com/wp-content/uploads/2015/04/Vegetable-Lo-Mein-5.jpg",
...
function createButtons() {
  let arrayLength = filteredCategories.length;
  for (var i = 0; i < arrayLength; i++) {
     let btn = document.createElement("button");
     btn.innerHTML = filteredCategories[i];
     btn.classList.add("btn-item")
     btn.onclick = menuHandler;
...
menu.map(menu => {
  sectionCenter.innerHTML += createItems(menu);
});
